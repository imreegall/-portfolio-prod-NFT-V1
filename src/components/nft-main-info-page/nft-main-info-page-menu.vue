...
<!--          <li>-->
<!--              <router-link to="/">-->
<!--                <button class="nft-btn">ПЕРЕЙТИ К КОЛЛЕКЦИИ</button>-->
<!--              </router-link>-->
<!--          </li>-->
        </ul>
      </li>
      ...
      <li class="mainPageMenuPresaleText">
        <ul>
          ...
          <li><button class="nft-btn">
            <a rel="nofollow" target="_blank" title="https://t.me/historicalcollection" href="https://t.me/historicalcollection">
              {{$t('mainInfoPage.menu.preSale.text[4]')}}
            </a>
          </button></li>
        </ul>
      </li>
